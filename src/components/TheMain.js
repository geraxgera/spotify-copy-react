...
const playlists = [
  {
    ...
    coverUrl: "https://fakeimg.pl/600/7f1d1d/fff?text=Cover&font=Gotham",
  },
  {
    classes: "hidden sm:block",
    title: "Playlist title 2",
    description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit.",
    coverUrl: "https://fakeimg.pl/600/365314/fff?text=Cover&font=Gotham",
  },
  {
    classes: "hidden lg:block",
    title: "Playlist title 3",
    description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit.",
    coverUrl: "https://fakeimg.pl/600/164e63/fff?text=Cover&font=Gotham",
  },
  {
    classes: "hidden xl:block",
    title: "Playlist title 4",
    description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit.",
    coverUrl: "https://fakeimg.pl/600/1e3a8a/fff?text=Cover&font=Gotham",
  },
  {
          ...
          <div className="grid sm:grid-cols-playlists-mobile md:grid-cols-playlists-tablet lg:grid-cols-playlists-desktop gap-5">
            ...
            >
              <div className="relative">
                <img
                  src="https://fakeimg.pl/600/7f1d1d/fff?text=Cover&font=Gotham"
            ...
            >
              <div className="relative">
                <img
                  src="https://fakeimg.pl/600/365314/fff?text=Cover&font=Gotham"
                  className="rounded shadow-lg"
                  alt=""
                />
                <button className="h-10 w-10 bg-[#1cb955] rounded-full shadow-xl absolute right-2 bottom-2 flex justify-center items-center cursor-auto duration-200 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 hover:scale-105">
            ...
            >
              <div className="relative">
                <img
                  src="https://fakeimg.pl/600/164e63/fff?text=Cover&font=Gotham"
                  className="rounded shadow-lg"
                  alt=""
                />
                <button className="h-10 w-10 bg-[#1cb955] rounded-full shadow-xl absolute right-2 bottom-2 flex justify-center items-center cursor-auto duration-200 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 hover:scale-105">
            ...
            >
              <div className="relative">
                <img
                  src="https://fakeimg.pl/600/1e3a8a/fff?text=Cover&font=Gotham"
                  className="rounded shadow-lg"
                  alt=""
                />
                <button className="h-10 w-10 bg-[#1cb955] rounded-full shadow-xl absolute right-2 bottom-2 flex justify-center items-center cursor-auto duration-200 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 hover:scale-105">
